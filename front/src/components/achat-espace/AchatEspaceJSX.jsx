...
import './AchatEspaceJSX.css'; // Assurez-vous d'ajouter ce fichier pour les styles personnalisés si nécessaire
...
const AchatEspaceJSX = () => {
  ...
  return (
    <div className='achat-espace' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', padding: '20px' }}>
      <Card title="Acheter de l'Espace Supplémentaire" style={{ width: 400, textAlign: 'center', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '8px', padding: '20px' }}>
